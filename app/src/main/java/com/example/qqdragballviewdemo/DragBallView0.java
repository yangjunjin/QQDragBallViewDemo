...
public class DragBallView0 extends View {
    ...
    public DragBallView0(Context context) {
        this(context, null);
    }

    public DragBallView0(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public DragBallView0(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
